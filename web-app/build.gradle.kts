...
tasks.register<Copy>("copyFrontendResources") {
    ...
    into(layout.buildDirectory.dir("resources/main/web/app/key-value-storage/static"))
}
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "web-app-key-value-storage"
            pom {
                packaging = "jar"
                url = "https://github.com/sibdevtools/web-app-key-value-storage"
                ...
                scm {
                    connection.set("scm:https://github.com/sibdevtools/web-app-key-value-storage.git")
                    developerConnection.set("scm:git:ssh://github.com/sibdevtools")
                    url.set("https://github.com/sibdevtools/web-app-key-value-storage")
                }
